...
To test the absolute limits of the `BigInt` Miller-Rabin engine, the scanner was initialized at $k = 10^{30}$ (1 Nonillion). The system cleared the localized composite numbers instantly:
